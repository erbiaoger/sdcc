      ...
      000062                        358 _main:
                           ...
                           000001   365 	ar1 = 0x01
                           000000   366 	ar0 = 0x00
                                    367 ;	a.c:11: KEY=1; //按键输入端口电平置高
                                    368 ;	assignBit
      000062 D2 B2            [12]  369 	setb	_P3_2
                                    370 ;	a.c:12: while (1)         //主循环
      000064                        371 00105$:
                                    372 ;	a.c:15: if(!KEY)  //如果检测到低电平，说明按键按下
      000064 20 B2 04         [24]  373 	jb	_P3_2,00102$
                                    374 ;	a.c:16: LED=0;
                                    375 ;	assignBit
      000067 C2 92            [12]  376 	clr	_P1_2
      000069 80 F9            [24]  377 	sjmp	00105$
      00006B                        378 00102$:
                                    379 ;	a.c:18: LED=1;  //这里使用if判断，如果按键按下led点亮，否则熄灭
                                    380 ;	assignBit
      00006B D2 92            [12]  381 	setb	_P1_2
                                    382 ;	a.c:22: }
      00006D 80 F5            [24]  383 	sjmp	00105$
                                    384 	.area CSEG    (CODE)
                                    385 	.area CONST   (CODE)
                                    386 	.area XINIT   (CODE)
