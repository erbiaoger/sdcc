      ...
      000003 02 00 77         [24]  347 	ljmp	_main
      ...
      000062                        362 _delay:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	c.c:6: for (unsigned int i = 0; i < 500; i++);
      000062 7E 00            [12]  372 	mov	r6,#0x00
      000064 7F 00            [12]  373 	mov	r7,#0x00
      000066                        374 00103$:
      000066 C3               [12]  375 	clr	c
      000067 EE               [12]  376 	mov	a,r6
      000068 94 F4            [12]  377 	subb	a,#0xf4
      00006A EF               [12]  378 	mov	a,r7
      00006B 94 01            [12]  379 	subb	a,#0x01
      00006D 50 07            [24]  380 	jnc	00105$
      00006F 0E               [12]  381 	inc	r6
      000070 BE 00 F3         [24]  382 	cjne	r6,#0x00,00103$
      000073 0F               [12]  383 	inc	r7
      000074 80 F0            [24]  384 	sjmp	00103$
      000076                        385 00105$:
                                    386 ;	c.c:7: }
      000076 22               [24]  387 	ret
                                    388 ;------------------------------------------------------------
                                    389 ;Allocation info for local variables in function 'main'
                                    390 ;------------------------------------------------------------
                                    391 ;	c.c:10: void main(){
                                    392 ;	-----------------------------------------
                                    393 ;	 function main
                                    394 ;	-----------------------------------------
      000077                        395 _main:
      ...
      000077                        397 00104$:
                                    398 ;	c.c:12: if (KEY == 0){
      000077 20 B4 02         [24]  399 	jb	_P3_4,00102$
                                    400 ;	c.c:13: LED = 0;
                                    401 ;	assignBit
      00007A C2 91            [12]  402 	clr	_P1_1
      00007C                        403 00102$:
                                    404 ;	c.c:15: delay();
      00007C 12 00 62         [24]  405 	lcall	_delay
                                    406 ;	c.c:16: LED = 1;
                                    407 ;	assignBit
      00007F D2 91            [12]  408 	setb	_P1_1
                                    409 ;	c.c:19: }
      000081 80 F4            [24]  410 	sjmp	00104$
                                    411 	.area CSEG    (CODE)
                                    412 	.area CONST   (CODE)
                                    413 	.area XINIT   (CODE)
