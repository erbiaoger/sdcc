      ...
      000062                        362 _delay:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	d.c:4: for (unsigned int i = 0; i < 500; i++);
      ...
      000077                        397 00102$:
                                    398 ;	d.c:11: P1 = 0xff;
      000077 75 90 FF         [24]  399 	mov	_P1,#0xff
                                    400 ;	d.c:12: P1 = P3;
      00007A 85 B0 90         [24]  401 	mov	_P1,_P3
                                    402 ;	d.c:13: delay();
      00007D 12 00 62         [24]  403 	lcall	_delay
                                    404 ;	d.c:16: }
      000080 80 F5            [24]  405 	sjmp	00102$
                                    406 	.area CSEG    (CODE)
                                    407 	.area CONST   (CODE)
                                    408 	.area XINIT   (CODE)
