      ...
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	b.c:8: Delay(5000);
      000062 90 13 88         [24]  372 	mov	dptr,#0x1388
      000065 12 00 89         [24]  373 	lcall	_Delay
                                    374 ;	b.c:9: P1=0x01;           
      000068 75 90 01         [24]  375 	mov	_P1,#0x01
                                    376 ;	b.c:12: for(i=0;i<8;i++)  
      00006B                        377 00109$:
      00006B 7F 00            [12]  378 	mov	r7,#0x00
      00006D                        379 00105$:
                                    380 ;	b.c:14: Delay(50000);
      00006D 90 C3 50         [24]  381 	mov	dptr,#0xc350
      000070 C0 07            [24]  382 	push	ar7
      000072 12 00 89         [24]  383 	lcall	_Delay
      ...
      00007C F5 90            [12]  389 	mov	_P1,a
                                    390 ;	b.c:12: for(i=0;i<8;i++)  
      00007E 0F               [12]  391 	inc	r7
      00007F BF 08 00         [24]  392 	cjne	r7,#0x08,00122$
      000082                        393 00122$:
      000082 40 E9            [24]  394 	jc	00105$
                                    395 ;	b.c:17: P1=0x01;          
      000084 75 90 01         [24]  396 	mov	_P1,#0x01
                                    397 ;	b.c:20: }
      000087 80 E2            [24]  398 	sjmp	00109$
                                    399 ;------------------------------------------------------------
                                    400 ;Allocation info for local variables in function 'Delay'
                                    401 ;------------------------------------------------------------
                                    402 ;t                         Allocated to registers 
                                    403 ;------------------------------------------------------------
                                    404 ;	b.c:22: void Delay(unsigned int t)
                                    405 ;	-----------------------------------------
                                    406 ;	 function Delay
                                    407 ;	-----------------------------------------
      000089                        408 _Delay:
      000089 AE 82            [24]  409 	mov	r6,dpl
      00008B AF 83            [24]  410 	mov	r7,dph
                                    411 ;	b.c:25: while(--t);
      00008D                        412 00101$:
      00008D 1E               [12]  413 	dec	r6
      00008E BE FF 01         [24]  414 	cjne	r6,#0xff,00111$
      000091 1F               [12]  415 	dec	r7
      000092                        416 00111$:
      000092 EE               [12]  417 	mov	a,r6
      000093 4F               [12]  418 	orl	a,r7
      000094 70 F7            [24]  419 	jnz	00101$
                                    420 ;	b.c:27: }
      000096 22               [24]  421 	ret
                                    422 	.area CSEG    (CODE)
                                    423 	.area CONST   (CODE)
                                    424 	.area XINIT   (CODE)
