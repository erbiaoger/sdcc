      ...
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	b.c:8: Delay(50000);
      000062 90 C3 50         [24]  372 	mov	dptr,#0xc350
      000065 12 00 85         [24]  373 	lcall	_Delay
                                    374 ;	b.c:9: P1=0xff;          
      000068 75 90 FF         [24]  375 	mov	_P1,#0xff
                                    376 ;	b.c:10: for(i=0;i<8;i++)  
      00006B 7F 00            [12]  377 	mov	r7,#0x00
      00006D                        378 00105$:
                                    379 ;	b.c:12: Delay(50000);
      00006D 90 C3 50         [24]  380 	mov	dptr,#0xc350
      000070 C0 07            [24]  381 	push	ar7
      000072 12 00 85         [24]  382 	lcall	_Delay
      000075 D0 07            [24]  383 	pop	ar7
                                    384 ;	b.c:13: P1>>=1;
      000077 E5 90            [12]  385 	mov	a,_P1
      000079 C3               [12]  386 	clr	c
      00007A 13               [12]  387 	rrc	a
      00007B F5 90            [12]  388 	mov	_P1,a
                                    389 ;	b.c:10: for(i=0;i<8;i++)  
      00007D 0F               [12]  390 	inc	r7
      00007E BF 08 00         [24]  391 	cjne	r7,#0x08,00118$
      000081                        392 00118$:
      000081 40 EA            [24]  393 	jc	00105$
                                    394 ;	b.c:16: while (1)        
      000083                        395 00103$:
                                    396 ;	b.c:20: }
      000083 80 FE            [24]  397 	sjmp	00103$
                                    398 ;------------------------------------------------------------
                                    399 ;Allocation info for local variables in function 'Delay'
                                    400 ;------------------------------------------------------------
                                    401 ;t                         Allocated to registers 
                                    402 ;------------------------------------------------------------
                                    403 ;	b.c:22: void Delay(unsigned int t)
                                    404 ;	-----------------------------------------
                                    405 ;	 function Delay
                                    406 ;	-----------------------------------------
      000085                        407 _Delay:
      000085 AE 82            [24]  408 	mov	r6,dpl
      000087 AF 83            [24]  409 	mov	r7,dph
                                    410 ;	b.c:24: while(--t);
      000089                        411 00101$:
      000089 1E               [12]  412 	dec	r6
      00008A BE FF 01         [24]  413 	cjne	r6,#0xff,00111$
      00008D 1F               [12]  414 	dec	r7
      00008E                        415 00111$:
      00008E EE               [12]  416 	mov	a,r6
      00008F 4F               [12]  417 	orl	a,r7
      000090 70 F7            [24]  418 	jnz	00101$
                                    419 ;	b.c:25: }
      000092 22               [24]  420 	ret
                                    421 	.area CSEG    (CODE)
                                    422 	.area CONST   (CODE)
                                    423 	.area XINIT   (CODE)
