      ...
      000003 02 00 74         [24]  347 	ljmp	_main
      ...
      000062                        362 _delay:
                           ...
                           000000   370 	ar0 = 0x00
                                    371 ;	b.c:6: while(i--);
      000062 7E 10            [12]  372 	mov	r6,#0x10
      000064 7F 27            [12]  373 	mov	r7,#0x27
      000066                        374 00101$:
      000066 8E 04            [24]  375 	mov	ar4,r6
      000068 8F 05            [24]  376 	mov	ar5,r7
      00006A 1E               [12]  377 	dec	r6
      00006B BE FF 01         [24]  378 	cjne	r6,#0xff,00111$
      00006E 1F               [12]  379 	dec	r7
      00006F                        380 00111$:
      00006F EC               [12]  381 	mov	a,r4
      000070 4D               [12]  382 	orl	a,r5
      000071 70 F3            [24]  383 	jnz	00101$
                                    384 ;	b.c:7: }
      000073 22               [24]  385 	ret
                                    386 ;------------------------------------------------------------
                                    387 ;Allocation info for local variables in function 'main'
                                    388 ;------------------------------------------------------------
                                    389 ;a                         Allocated to registers r6 r7 
                                    390 ;i                         Allocated to registers r5 
                                    391 ;------------------------------------------------------------
                                    392 ;	b.c:9: void main() {
                                    393 ;	-----------------------------------------
                                    394 ;	 function main
                                    395 ;	-----------------------------------------
      000074                        396 _main:
                                    397 ;	b.c:10: unsigned int a = 0xfe;
      000074 7E FE            [12]  398 	mov	r6,#0xfe
      000076 7F 00            [12]  399 	mov	r7,#0x00
                                    400 ;	b.c:11: unsigned char i = 0;
      000078 7D 00            [12]  401 	mov	r5,#0x00
                                    402 ;	b.c:12: while(1) {
      00007A                        403 00107$:
                                    404 ;	b.c:13: if (P2_0 == 0)
      00007A 20 A0 25         [24]  405 	jb	_P2_0,00105$
                                    406 ;	b.c:15: if (i != 7) {
      00007D BD 07 02         [24]  407 	cjne	r5,#0x07,00124$
      000080 80 1A            [24]  408 	sjmp	00102$
      000082                        409 00124$:
                                    410 ;	b.c:16: P1 = (a>>1) | ~a;
      000082 8E 03            [24]  411 	mov	ar3,r6
      000084 EF               [12]  412 	mov	a,r7
      000085 C3               [12]  413 	clr	c
      000086 13               [12]  414 	rrc	a
      000087 CB               [12]  415 	xch	a,r3
      000088 13               [12]  416 	rrc	a
      000089 CB               [12]  417 	xch	a,r3
      00008A FC               [12]  418 	mov	r4,a
      00008B 8E 02            [24]  419 	mov	ar2,r6
      00008D EA               [12]  420 	mov	a,r2
      00008E F4               [12]  421 	cpl	a
      00008F FA               [12]  422 	mov	r2,a
      000090 8B 01            [24]  423 	mov	ar1,r3
      000092 49               [12]  424 	orl	a,r1
      000093 F5 90            [12]  425 	mov	_P1,a
                                    426 ;	b.c:17: a = a>>1;
      000095 8B 06            [24]  427 	mov	ar6,r3
      000097 8C 07            [24]  428 	mov	ar7,r4
                                    429 ;	b.c:18: i++;
      000099 0D               [12]  430 	inc	r5
      00009A 80 06            [24]  431 	sjmp	00105$
      00009C                        432 00102$:
                                    433 ;	b.c:22: i = 0;
      00009C 7D 00            [12]  434 	mov	r5,#0x00
                                    435 ;	b.c:23: a = 0xfe;
      00009E 7E FE            [12]  436 	mov	r6,#0xfe
      0000A0 7F 00            [12]  437 	mov	r7,#0x00
      0000A2                        438 00105$:
                                    439 ;	b.c:28: delay();
      0000A2 C0 07            [24]  440 	push	ar7
      0000A4 C0 06            [24]  441 	push	ar6
      0000A6 C0 05            [24]  442 	push	ar5
      0000A8 12 00 62         [24]  443 	lcall	_delay
      0000AB D0 05            [24]  444 	pop	ar5
      0000AD D0 06            [24]  445 	pop	ar6
      0000AF D0 07            [24]  446 	pop	ar7
                                    447 ;	b.c:31: }
      0000B1 80 C7            [24]  448 	sjmp	00107$
                                    449 	.area CSEG    (CODE)
                                    450 	.area CONST   (CODE)
                                    451 	.area XINIT   (CODE)
