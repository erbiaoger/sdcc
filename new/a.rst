      ...
      000073 22               [24]  385 	ret
                                    ...
                                    388 ;------------------------------------------------------------
                                    389 ;a                         Allocated to registers r7 
                                    390 ;------------------------------------------------------------
                                    391 ;	a.c:8: void main() {
                                    392 ;	-----------------------------------------
                                    393 ;	 function main
                                    394 ;	-----------------------------------------
      000074                        395 _main:
                                    396 ;	a.c:9: unsigned char a = 0xFF;
      000074 7F FF            [12]  397 	mov	r7,#0xff
                                    398 ;	a.c:10: while(1) {
      000076                        399 00104$:
                                    400 ;	a.c:11: if (P2_0 == 0)
      000076 20 A0 08         [24]  401 	jb	_P2_0,00102$
                                    402 ;	a.c:13: P1 = a - 1;
      000079 8F 06            [24]  403 	mov	ar6,r7
      00007B EE               [12]  404 	mov	a,r6
      00007C 14               [12]  405 	dec	a
      00007D F5 90            [12]  406 	mov	_P1,a
                                    407 ;	a.c:14: a = P1;
      00007F AF 90            [24]  408 	mov	r7,_P1
      000081                        409 00102$:
                                    410 ;	a.c:16: delay();
      000081 C0 07            [24]  411 	push	ar7
      000083 12 00 62         [24]  412 	lcall	_delay
      000086 D0 07            [24]  413 	pop	ar7
                                    414 ;	a.c:19: }
      000088 80 EC            [24]  415 	sjmp	00104$
                                    416 	.area CSEG    (CODE)
                                    417 	.area CONST   (CODE)
                                    418 	.area XINIT   (CODE)
