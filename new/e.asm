...
;	e.c:3: unsigned char NixieTable[] = {0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07, 0x7F, 0x6F};
...
;------------------------------------------------------------
;	e.c:5: void Nixie(unsigned char Location, unsigned char Number) {
;	-----------------------------------------
;	 function Nixie
;	-----------------------------------------
_Nixie:
...
;	e.c:6: switch (Location) {
	...
	mov	a,r7
	add	a,r7
;	e.c:7: case 1: {P2_4 = 1; P2_3 = 1; P2_2 = 1; break;}
	mov	dptr,#00115$
	jmp	@a+dptr
00115$:
	sjmp	00107$
...
;	assignBit
	setb	_P2_2
;	e.c:8: case 2: {P2_4 = 1; P2_3 = 1; P2_2 = 0; break;}
	sjmp	00107$
00102$:
;	assignBit
	setb	_P2_4
...
;	assignBit
	clr	_P2_2
;	e.c:9: case 3: {P2_4 = 1; P2_3 = 0; P2_2 = 1; break;}
	sjmp	00107$
00103$:
;	assignBit
	setb	_P2_4
...
;	assignBit
	setb	_P2_2
;	e.c:10: case 4: {P2_4 = 1; P2_3 = 0; P2_2 = 0; break;}
	sjmp	00107$
00104$:
;	assignBit
	setb	_P2_4
...
;	assignBit
	clr	_P2_2
;	e.c:11: case 5: {P2_4 = 0; P2_3 = 1; P2_2 = 1; break;}
	sjmp	00107$
00105$:
;	assignBit
	clr	_P2_4
...
;	assignBit
	setb	_P2_2
;	e.c:12: case 6: {P2_4 = 0; P2_3 = 1; P2_2 = 0; break;}
	sjmp	00107$
00106$:
;	assignBit
	clr	_P2_4
