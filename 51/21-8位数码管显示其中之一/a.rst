      ...
      000062                        358 _main:
                           ...
                           000000   366 	ar0 = 0x00
                                    367 ;	a.c:9: while(1)
      000062                        368 00102$:
                                    369 ;	a.c:11: DataPort=0xfe;
      000062 75 80 FE         [24]  370 	mov	_P0,#0xfe
                                    371 ;	a.c:12: LATCH1=1;     
                                    372 ;	assignBit
      000065 D2 A2            [12]  373 	setb	_P2_2
                                    374 ;	a.c:13: LATCH2=0;
                                    375 ;	assignBit
      000067 C2 A3            [12]  376 	clr	_P2_3
                                    377 ;	a.c:15: DataPort=0x4F; 
      000069 75 80 4F         [24]  378 	mov	_P0,#0x4f
                                    379 ;	a.c:16: LATCH2=1;    
                                    380 ;	assignBit
      00006C D2 A3            [12]  381 	setb	_P2_3
                                    382 ;	a.c:17: LATCH1=0;
                                    383 ;	assignBit
      00006E C2 A2            [12]  384 	clr	_P2_2
                                    385 ;	a.c:19: }
      000070 80 F0            [24]  386 	sjmp	00102$
                                    387 	.area CSEG    (CODE)
                                    388 	.area CONST   (CODE)
                                    389 	.area XINIT   (CODE)
