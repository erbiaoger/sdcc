      ...
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	a.c:9: Delay(5000);
      000062 90 13 88         [24]  372 	mov	dptr,#0x1388
      000065 12 00 8C         [24]  373 	lcall	_Delay
                                    374 ;	a.c:10: P1=0xfe;           
      000068 75 90 FE         [24]  375 	mov	_P1,#0xfe
                                    376 ;	a.c:13: for(i=0;i<8;i++)  
      00006B                        377 00109$:
      00006B 7F 00            [12]  378 	mov	r7,#0x00
      00006D                        379 00105$:
                                    380 ;	a.c:15: Delay(50000);
      00006D 90 C3 50         [24]  381 	mov	dptr,#0xc350
      000070 C0 07            [24]  382 	push	ar7
      000072 12 00 8C         [24]  383 	lcall	_Delay
      000075 D0 07            [24]  384 	pop	ar7
                                    385 ;	a.c:16: P1<<=1;
      000077 E5 90            [12]  386 	mov	a,_P1
      000079 FE               [12]  387 	mov	r6,a
      00007A 25 E0            [12]  388 	add	a,acc
      00007C F5 90            [12]  389 	mov	_P1,a
                                    390 ;	a.c:17: P1=P1|0x01;     
      00007E 43 90 01         [24]  391 	orl	_P1,#0x01
                                    392 ;	a.c:13: for(i=0;i<8;i++)  
      000081 0F               [12]  393 	inc	r7
      000082 BF 08 00         [24]  394 	cjne	r7,#0x08,00122$
      000085                        395 00122$:
      000085 40 E6            [24]  396 	jc	00105$
                                    397 ;	a.c:19: P1=0xfe;          
      000087 75 90 FE         [24]  398 	mov	_P1,#0xfe
                                    399 ;	a.c:22: }
      00008A 80 DF            [24]  400 	sjmp	00109$
                                    401 ;------------------------------------------------------------
                                    402 ;Allocation info for local variables in function 'Delay'
                                    403 ;------------------------------------------------------------
                                    404 ;t                         Allocated to registers 
                                    405 ;------------------------------------------------------------
                                    406 ;	a.c:24: void Delay(unsigned int t)
                                    407 ;	-----------------------------------------
                                    408 ;	 function Delay
                                    409 ;	-----------------------------------------
      00008C                        410 _Delay:
      00008C AE 82            [24]  411 	mov	r6,dpl
      00008E AF 83            [24]  412 	mov	r7,dph
                                    413 ;	a.c:27: while(--t);
      000090                        414 00101$:
      000090 1E               [12]  415 	dec	r6
      000091 BE FF 01         [24]  416 	cjne	r6,#0xff,00111$
      000094 1F               [12]  417 	dec	r7
      000095                        418 00111$:
      000095 EE               [12]  419 	mov	a,r6
      000096 4F               [12]  420 	orl	a,r7
      000097 70 F7            [24]  421 	jnz	00101$
                                    422 ;	a.c:29: }
      000099 22               [24]  423 	ret
                                    424 	.area CSEG    (CODE)
                                    425 	.area CONST   (CODE)
                                    426 	.area XINIT   (CODE)
