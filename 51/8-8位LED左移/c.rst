      ...
      000003 02 00 70         [24]  347 	ljmp	_main
                                    ...
                                    357 ;------------------------------------------------------------
                                    358 ;	c.c:3: void Delay(unsigned int i){
                                    359 ;	-----------------------------------------
                                    360 ;	 function Delay
                                    361 ;	-----------------------------------------
      000062                        362 _Delay:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
      000062 AE 82            [24]  371 	mov	r6,dpl
      000064 AF 83            [24]  372 	mov	r7,dph
                                    373 ;	c.c:4: while(--i);
      000066                        374 00101$:
      000066 1E               [12]  375 	dec	r6
      000067 BE FF 01         [24]  376 	cjne	r6,#0xff,00111$
      00006A 1F               [12]  377 	dec	r7
      00006B                        378 00111$:
      00006B EE               [12]  379 	mov	a,r6
      00006C 4F               [12]  380 	orl	a,r7
      00006D 70 F7            [24]  381 	jnz	00101$
                                    382 ;	c.c:5: }
      00006F 22               [24]  383 	ret
                                    384 ;------------------------------------------------------------
                                    385 ;Allocation info for local variables in function 'main'
                                    386 ;------------------------------------------------------------
                                    387 ;i                         Allocated to registers r7 
                                    388 ;------------------------------------------------------------
                                    389 ;	c.c:7: void main(){
                                    390 ;	-----------------------------------------
                                    391 ;	 function main
      ...
      000070                        395 00103$:
                                    396 ;	c.c:9: P1 = 0xff;
      000070 75 90 FF         [24]  397 	mov	_P1,#0xff
                                    398 ;	c.c:11: for (i = 0; i < 8; i++){
      000073 7F 00            [12]  399 	mov	r7,#0x00
      000075                        400 00105$:
                                    401 ;	c.c:12: P1<<=1;
      000075 E5 90            [12]  402 	mov	a,_P1
      000077 25 E0            [12]  403 	add	a,acc
      000079 F5 90            [12]  404 	mov	_P1,a
                                    405 ;	c.c:13: Delay(50000);
      00007B 90 C3 50         [24]  406 	mov	dptr,#0xc350
      00007E C0 07            [24]  407 	push	ar7
      000080 12 00 62         [24]  408 	lcall	_Delay
      000083 D0 07            [24]  409 	pop	ar7
                                    410 ;	c.c:11: for (i = 0; i < 8; i++){
      000085 0F               [12]  411 	inc	r7
      000086 BF 08 00         [24]  412 	cjne	r7,#0x08,00122$
      000089                        413 00122$:
      000089 40 EA            [24]  414 	jc	00105$
                                    415 ;	c.c:16: }
      00008B 80 E3            [24]  416 	sjmp	00103$
                                    417 	.area CSEG    (CODE)
                                    418 	.area CONST   (CODE)
                                    419 	.area XINIT   (CODE)
