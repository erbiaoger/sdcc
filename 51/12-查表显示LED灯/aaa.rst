      ...
      000003 02 00 70         [24]  347 	ljmp	_main
                                    ...
                                    355 ;------------------------------------------------------------
                                    356 ;n                         Allocated to registers r6 r7 
                                    357 ;------------------------------------------------------------
                                    358 ;	aaa.c:11: void delay(void)
                                    359 ;	-----------------------------------------
                                    360 ;	 function delay
                                    361 ;	-----------------------------------------
      000062                        362 _delay:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	aaa.c:17: for(n=0;n<10000;n++);
      ...
      00006F 22               [24]  383 	ret
                                    ...
                                    386 ;------------------------------------------------------------
                                    387 ;	aaa.c:27: void main(void)
                                    388 ;	-----------------------------------------
                                    389 ;	 function main
                                    390 ;	-----------------------------------------
      000070                        391 _main:
                                    392 ;	aaa.c:30: while(1){
      000070                        393 00105$:
                                    394 ;	aaa.c:32: if (!KEY)
      000070 20 B2 04         [24]  395 	jb	_P3_2,00102$
                                    396 ;	aaa.c:33: LED = 0;
                                    397 ;	assignBit
      000073 C2 92            [12]  398 	clr	_P1_2
      000075 80 F9            [24]  399 	sjmp	00105$
      000077                        400 00102$:
                                    401 ;	aaa.c:35: LED = 1;
                                    402 ;	assignBit
      000077 D2 92            [12]  403 	setb	_P1_2
                                    404 ;	aaa.c:39: }
      000079 80 F5            [24]  405 	sjmp	00105$
                                    406 	.area CSEG    (CODE)
                                    407 	.area CONST   (CODE)
                                    408 	.area XINIT   (CODE)
