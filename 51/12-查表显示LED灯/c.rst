      ...
      000003 02 00 7E         [24]  347 	ljmp	_main
                                    ...
                                    352 	.area CSEG    (CODE)
                                    353 ;------------------------------------------------------------
                                    354 ;Allocation info for local variables in function 'DelayXms'
                                    355 ;------------------------------------------------------------
                                    356 ;xms                       Allocated to registers 
                                    357 ;i                         Allocated to registers r4 
                                    358 ;j                         Allocated to registers r5 
                                    359 ;------------------------------------------------------------
                                    360 ;	c.c:2: void DelayXms(unsigned int xms)
                                    361 ;	-----------------------------------------
                                    362 ;	 function DelayXms
                                    363 ;	-----------------------------------------
      000062                        364 _DelayXms:
                           000007   365 	ar7 = 0x07
                           000006   366 	ar6 = 0x06
                           000005   367 	ar5 = 0x05
                           000004   368 	ar4 = 0x04
      ...
      00007D 22               [24]  396 	ret
                                    ...
                                    399 ;------------------------------------------------------------
                                    400 ;LedNum                    Allocated to registers r7 
                                    401 ;------------------------------------------------------------
                                    402 ;	c.c:16: void main()
                                    403 ;	-----------------------------------------
                                    404 ;	 function main
                                    405 ;	-----------------------------------------
      00007E                        406 _main:
                                    407 ;	c.c:18: unsigned char LedNum=0;
      00007E 7F 00            [12]  408 	mov	r7,#0x00
                                    409 ;	c.c:19: P2_0=0;
                                    410 ;	assignBit
      000080 C2 A0            [12]  411 	clr	_P2_0
                                    412 ;	c.c:20: while(1)
      000082                        413 00109$:
                                    414 ;	c.c:22: if(P3_3==0)
      000082 20 B3 FD         [24]  415 	jb	_P3_3,00109$
                                    416 ;	c.c:25: DelayXms(20);
      000085 90 00 14         [24]  417 	mov	dptr,#0x0014
      000088 C0 07            [24]  418 	push	ar7
      00008A 12 00 62         [24]  419 	lcall	_DelayXms
      00008D D0 07            [24]  420 	pop	ar7
                                    421 ;	c.c:26: while(P3_3==0);
      00008F                        422 00101$:
      00008F 30 B3 FD         [24]  423 	jnb	_P3_3,00101$
                                    424 ;	c.c:27: DelayXms(20);
      000092 90 00 14         [24]  425 	mov	dptr,#0x0014
      000095 C0 07            [24]  426 	push	ar7
      000097 12 00 62         [24]  427 	lcall	_DelayXms
      00009A D0 07            [24]  428 	pop	ar7
                                    429 ;	c.c:29: LedNum++;
      00009C 0F               [12]  430 	inc	r7
                                    431 ;	c.c:30: if(LedNum==8)
      00009D BF 08 02         [24]  432 	cjne	r7,#0x08,00105$
                                    433 ;	c.c:31: {LedNum=0;}
      0000A0 7F 00            [12]  434 	mov	r7,#0x00
      0000A2                        435 00105$:
                                    436 ;	c.c:32: P2=~(0x01<<LedNum);
      0000A2 8F 06            [24]  437 	mov	ar6,r7
      0000A4 8E F0            [24]  438 	mov	b,r6
      0000A6 05 F0            [12]  439 	inc	b
      0000A8 74 01            [12]  440 	mov	a,#0x01
      0000AA 80 02            [24]  441 	sjmp	00139$
      0000AC                        442 00137$:
      0000AC 25 E0            [12]  443 	add	a,acc
      0000AE                        444 00139$:
      0000AE D5 F0 FB         [24]  445 	djnz	b,00137$
      0000B1 F4               [12]  446 	cpl	a
      0000B2 F5 A0            [12]  447 	mov	_P2,a
                                    448 ;	c.c:35: }
      0000B4 80 CC            [24]  449 	sjmp	00109$
                                    450 	.area CSEG    (CODE)
                                    451 	.area CONST   (CODE)
                                    452 	.area XINIT   (CODE)
