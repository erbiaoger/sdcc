      ...
      000003 02 00 83         [24]  347 	ljmp	_main
                                    ...
                                    358 ;------------------------------------------------------------
                                    359 ;	b.c:8: void delay_ms(unsigned int s){
                                    360 ;	-----------------------------------------
      ...
      000082 22               [24]  400 	ret
                                    ...
                                    403 ;------------------------------------------------------------
                                    404 ;	b.c:20: void main(){
                                    405 ;	-----------------------------------------
                                    406 ;	 function main
                                    407 ;	-----------------------------------------
      000083                        408 _main:
                                    409 ;	b.c:22: while(1){ //主循环
      000083                        410 00102$:
                                    411 ;	b.c:24: ADDR0 = 0;
                                    412 ;	assignBit
      000083 C2 90            [12]  413 	clr	_P1_0
                                    414 ;	b.c:27: delay_ms(150);
      000085 90 00 96         [24]  415 	mov	dptr,#0x0096
      000088 12 00 62         [24]  416 	lcall	_delay_ms
                                    417 ;	b.c:28: ADDR0 = 1;
                                    418 ;	assignBit
      00008B D2 90            [12]  419 	setb	_P1_0
                                    420 ;	b.c:32: }
      00008D 80 F4            [24]  421 	sjmp	00102$
                                    422 	.area CSEG    (CODE)
                                    423 	.area CONST   (CODE)
                                    424 	.area XINIT   (CODE)
