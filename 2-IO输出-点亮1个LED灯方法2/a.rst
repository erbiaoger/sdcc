      ...
      000003 02 00 70         [24]  347 	ljmp	_main
                                    ...
                                    352 	.area CSEG    (CODE)
                                    353 ;------------------------------------------------------------
                                    354 ;Allocation info for local variables in function 'deploy'
                                    355 ;------------------------------------------------------------
                                    356 ;i                         Allocated to registers r6 r7 
                                    357 ;------------------------------------------------------------
                                    358 ;	a.c:5: void deploy(){
                                    359 ;	-----------------------------------------
                                    360 ;	 function deploy
                                    361 ;	-----------------------------------------
      000062                        362 _deploy:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	a.c:7: for (i = 0; i < 50000; i++);
      000062 7E 50            [12]  372 	mov	r6,#0x50
      000064 7F C3            [12]  373 	mov	r7,#0xc3
      000066                        374 00104$:
      000066 1E               [12]  375 	dec	r6
      000067 BE FF 01         [24]  376 	cjne	r6,#0xff,00113$
      00006A 1F               [12]  377 	dec	r7
      00006B                        378 00113$:
      00006B EE               [12]  379 	mov	a,r6
      00006C 4F               [12]  380 	orl	a,r7
      00006D 70 F7            [24]  381 	jnz	00104$
                                    382 ;	a.c:8: }
      00006F 22               [24]  383 	ret
                                    384 ;------------------------------------------------------------
                                    385 ;Allocation info for local variables in function 'main'
                                    386 ;------------------------------------------------------------
                                    387 ;	a.c:11: void main (void)
                                    388 ;	-----------------------------------------
                                    389 ;	 function main
                                    390 ;	-----------------------------------------
      000070                        391 _main:
                                    392 ;	a.c:13: while(1){
      000070                        393 00102$:
                                    394 ;	a.c:14: P1 = 0B11111111;
      000070 75 90 FF         [24]  395 	mov	_P1,#0xff
                                    396 ;	a.c:15: deploy();
      000073 12 00 62         [24]  397 	lcall	_deploy
                                    398 ;	a.c:16: P1 = 0B00000000;
      000076 75 90 00         [24]  399 	mov	_P1,#0x00
                                    400 ;	a.c:17: deploy();
      000079 12 00 62         [24]  401 	lcall	_deploy
                                    402 ;	a.c:26: }
      00007C 80 F2            [24]  403 	sjmp	00102$
                                    404 	.area CSEG    (CODE)
                                    405 	.area CONST   (CODE)
                                    406 	.area XINIT   (CODE)
