      ...
      000003 02 00 64         [24]  347 	ljmp	_main
      ...
      000062                        362 _deploy:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	b.c:6: for (i = 0; i < 100000; i++);
      000062                        372 00103$:
                                    373 ;	b.c:7: }
      000062 80 FE            [24]  374 	sjmp	00103$
                                    375 ;------------------------------------------------------------
      ...
      000064                        382 _main:
                                    383 ;	b.c:11: P1 = 0x00;
      000064 75 90 00         [24]  384 	mov	_P1,#0x00
                                    385 ;	b.c:12: while(1){
      000067                        386 00102$:
                                    387 ;	b.c:13: P1 = P1 << 1;
      000067 E5 90            [12]  388 	mov	a,_P1
      000069 25 E0            [12]  389 	add	a,acc
      00006B F5 90            [12]  390 	mov	_P1,a
                                    391 ;	b.c:14: deploy();
      00006D 12 00 62         [24]  392 	lcall	_deploy
                                    393 ;	b.c:16: }
      000070 80 F5            [24]  394 	sjmp	00102$
                                    395 	.area CSEG    (CODE)
                                    396 	.area CONST   (CODE)
                                    397 	.area XINIT   (CODE)
